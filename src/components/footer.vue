...
<template>
  ...
  <div class="md:flex justify-between items-center">
    <div class="mb-4 md:mb-0">Designed and built <span class="text-red-500">♥</span> by <a class="hover:underline text-gray-600" href="https://github.com/desmondsol">Solomon Tigabu</a>.</div>
